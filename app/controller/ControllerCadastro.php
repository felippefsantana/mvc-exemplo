...
class ControllerCadastro extends ClassCadastro{
    ...
    // Chama o método de cadastro da ClassCadastro
    ...
    public function seleciona() {
        ...
        foreach($B as $C) {
            echo "
                <tr>
                    <td><input type='checkbox' id='Id' name='Id[]' value='$C[Id]'><img rel='$C[Id]' src='".DIRIMG."edit.png' class='ImageEdit'></td>
                    <td>$C[Nome]</td>
                    <td>$C[Sexo]</td>
                    <td>$C[Cidade]</td>
                </tr>
    ...
    public function puxaDB($Id) {
        ...
        <form name='FormAtualizar' id='FormAtualizar' action='".DIRPAGE."cadastro/atualizar/$Id' method='post'>
